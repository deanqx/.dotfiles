...
vim.keymap.set("n", "<leader>i", function() harpoon:list():select(2) end, { desc = 'Harpoon: Goto 2' })
vim.keymap.set("n", "<leader>m", function() harpoon:list():select(3) end, { desc = 'Harpoon: Goto 3' })
vim.keymap.set("n", "<leader>o", function() harpoon:list():select(4) end, { desc = 'Harpoon: Goto 4' })
